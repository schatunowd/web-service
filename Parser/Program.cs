...
namespace KinopoiskParser
{
    ...
    public class Program
    {
        ...
        static List<string> getCommentsByFilmId(string filmId, bool reviewParam)
        {
        ...
        public static List<string> ParserExec(string filmName, bool reviewParam)
        {
            string filmId = getFilmIdByFilmName(filmName);
            List<string> comments = getCommentsByFilmId(filmId, reviewParam);
            return comments;
        }
